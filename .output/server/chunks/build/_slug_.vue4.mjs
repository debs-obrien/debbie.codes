...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    const { data: courses } = ([__temp, __restore] = withAsyncContext(() => useAsyncData(
      `courses-${slug}`,
      () => queryCollection("courses").where("tags", "LIKE", `%${slug}%`).order("date", "DESC").all()
      ...
      _push(ssrRenderComponent(_component_PageLayout, mergeProps({
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            return [
              unref(courses) !== null ? (openBlock(), createBlock(_component_ItemList, {
                key: 0,
                list: unref(courses),
                section
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/courses/tags/[slug].vue");
