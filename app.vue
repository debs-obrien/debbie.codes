<script setup>
const description = 'Debbie O\'Brien, Platform Engineer – Applied AI at Zephyr Cloud, with over 15 years experience in Frontend development. Google Developer Expert in web technologies, Previous Microsoft Most Valuable Professional in developer technologies, GitHub Star Alumni, NuxtJS Ambassador and Cloudinary Media Developer Expert.'
