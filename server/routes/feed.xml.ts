...
export default defineEventHandler(async (event) => {
  ...
  const feed = new Feed({
    title: 'Debbie Codes',
    description: 'Debbie O\'Brien - Senior Staff Developer Relations Engineer, with over 10 years experience in Frontend development. Writing about Playwright, testing, React, Nuxt and more.',
    id: siteUrl,
    link: siteUrl,
    language: 'en',
