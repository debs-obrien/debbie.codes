...
However the images were still an issue and I was tempted to actually just stop using Cloudinary just cause it was quicker and easier to use images stored in the public folder of my site. But then I would lose out on the benefits of Cloudinary and its image optimization.
