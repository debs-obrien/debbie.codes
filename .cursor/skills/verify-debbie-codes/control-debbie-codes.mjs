...
async function driveVideos(page, state, flags) {
  ...
  await expect(page.getByRole('heading', { name: 'Featured', level: 2 })).toBeVisible({ timeout: 20_000 })
  await expect(page.getByRole('heading', { name: /Latest|Search Results/i })).toBeVisible({ timeout: 20_000 })
